...
const Categories = () => {
  ...
  // const [firstProductByCategory, setfirstProductByCategory] = useState<Product[]>([])
  ...
  //     const categoryfetch  = await fetchProductsByCategory(category.slug);
  //     setfirstProductByCategory(categoryfetch.products)
  //   })
  // })

  // console.log(firstProductByCategory[0]);
              ...
              <div className="bg-gray-100 flex items-center w-full rounded-lg relative overflow-hidden h-[300px]">
                ...
                <div className="absolute bottom-3 z-10 w-4/5 left-[1.7rem]">
                  <div className={classnames(styles.buttonLight)}>
                    ...
                    <a href='#' className={classnames(styles.buttonLightAnchor)}>
                      All Productst
                    </a>
                  </div>
                </div>
